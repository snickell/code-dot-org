  ...
  module Resources
    module Apps
      module ExternalSources
        ...
        BLOCKLY_CORE_DIR_NAME = 'blockly'.freeze
        BLOCKLY_CORE_I18N_SOURCE_DIR = File.join(I18N_SOURCE_DIR_PATH, BLOCKLY_CORE_DIR_NAME).freeze
        ...
        OCEANS_DIR_NAME = 'ml-activities'.freeze
        OCEANS_I18N_SOURCE_DIR = File.join(I18N_SOURCE_DIR_PATH, OCEANS_DIR_NAME).freeze
