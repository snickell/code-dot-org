      ...
      module Blocks
        class SyncOut < I18n::Utils::SyncOutBase
          def process(language)
            ...
            distribute_localization(language[:locale_s], tms_file_path)
          ...
          private def distribute_localization(locale, file_path)
            tms_translations = I18nScriptUtils.parse_file(file_path)

            i18n_data = I18nScriptUtils.to_dashboard_i18n_data(locale, BLOCKS_TYPE, tms_translations)
