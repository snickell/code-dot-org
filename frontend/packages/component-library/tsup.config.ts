...
export default defineConfig({
  ...
  banner: {
    ...
    // Note: `index.css` is generated by `esbuild-sass-plugin`.
    // If no CSS is used by an entrypoint, no `index.css` will be generated.
    js: `
    try {
      await import('./index.css');
    } catch {
      // CSS may not be available for this component.
    }
    `,
  },
  esbuildPlugins: [
